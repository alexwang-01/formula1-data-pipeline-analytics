...
# MAGIC 1. Standardise column names using snake_case (`driverId` to `driver_id`, `dateOfbirth` to `date_of_birth`)
...
# MAGIC - Standardise column names using snake_case (`driverId` to `driver_id`, `dateOfBirth` to `date_of_birth`)
