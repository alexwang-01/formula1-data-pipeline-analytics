...
# MAGIC 1. Standardise column names using snake_case (`constructorId` to `constructor_id`)
# MAGIC 1. Rename columns to make them more meaningful (`name` to `constructor_name`)
...
# MAGIC - Standardise column names using snake_case (`constructorId` to `constructor_id`)
# MAGIC - Rename columns to make them more meaningful (`name` to `constructor_name`)
