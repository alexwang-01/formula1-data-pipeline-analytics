...
# MAGIC 1. Standardise column names using snake_case (`raceName` to `race_name`, `circuitId` to `circuit_id`)
# MAGIC 1. Rename columns to make them more meaningful (`date` to `race_date`)
...
# MAGIC - Standardise column names using snake_case (`circuitId` to `circuit_id`, `raceName` to `race_name`)
# MAGIC - Rename columns to make them more meaningful (`date` to `race_date`)
