...
# MAGIC     - is_podium -> Indicates that the driver finished the session in positions 1, 2, or 3
# MAGIC     - has_points -> Indicates that the driver scored points in the session
...
# MAGIC 1. is_podium -> Indicates that the driver finished the session in positions 1, 2, or 3
# MAGIC 1. has_points -> Indicates that the driver scored points in the session
# MAGIC
